...
bool Game::OnCreate()
{
	...
	glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT16, width, height); // Create the depth render buffer object
...
void Game::ImGuiDraw()
{
	...
	{
		newTexture->Reload(Utility::OpenFile(m_window.pWindow));
	}
	ImGui::SameLine();
	ImGui::Text("Texture");
